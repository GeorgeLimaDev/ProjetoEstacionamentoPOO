...
public class Interface {
	...
	private JLabel label_mensagens2;
	...
	private void initialize() {
		...
		button_consultar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(vagaPlaca.equals("-1")) {
					...
					label_mensagens.setText("O veículo de placa " + placa.toUpperCase() + " está na vaga " + vagaPlaca);}
			}
		...
		button_listarVagas.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
					...
					label_mensagens2.setText("Vagas:  " + sitVagas2);
		...
		label_mensagens.setBounds(60, 315, 475, 13);
		frame.getContentPane().add(label_mensagens);
		
		label_mensagens2 = new JLabel("");
		label_mensagens2.setBounds(60, 331, 475, 19);
		frame.getContentPane().add(label_mensagens2);
	}
}